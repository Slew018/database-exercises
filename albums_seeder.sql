...
VALUES  ('Michael Jackson', 'Thriller', 1982, 47.9, 'Pop, post-disco, funk, rock'),
        ('Lauryn Hill', 'The Miseductation of Lauryn Hill', 1998, 20, 'Neo Soul, R&B and Hip Hop'),
        ...
        ('The Eagles', 'Their Greatest Hits (1971-1975)', 1976, 41.2, 'Country rock, Soft rock, Folk Rock'),
        ...
        ('Michael Jackson', 'Bad', 1987, 19.7, 'Pop, R&B, Funk, Rock'),
        ...
        ('Bill Medley, Jennifer Warnes', 'Dirty Dancing', 1987, 17.9, 'Pop, Rock, R&B'),
